...
SOURCES = \
	__init__.py \
	hist_match.py hist_match_dialog.py

PLUGINNAME = hist_match

PY_FILES = \
	__init__.py \
	hist_match.py hist_match_dialog.py

UI_FILES = hist_match_dialog_base.ui
...
QGISDIR=C:\Users\Gustavo\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
